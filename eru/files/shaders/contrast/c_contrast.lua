...
function enableContrast()
	...
	-- Shaders
	contrastShader = dxCreateShader( "files/shaders/contrast/fx/contrast.fx" )
	bloomCombineShader = dxCreateShader( "files/shaders/contrast/fx/bloom_combine.fx" )
	bloomExtractShader = dxCreateShader( "files/shaders/contrast/fx/bloom_extract.fx" )
	blurHShader = dxCreateShader( "files/shaders/contrast/fx/blurH.fx" )
	blurVShader = dxCreateShader( "files/shaders/contrast/fx/blurV.fx" )
	modulationShader = dxCreateShader( "files/shaders/contrast/fx/modulation.fx" )
	...
	-- Overlay texture
	textureVignette = dxCreateTexture ( "files/shaders/contrast/images/vignette1.dds" );
	...
	addEventHandler( "onClientHUDRender", root, drawContrast)
end
...
function disableContrast()
	...
	bAllValid = false
	RTPool.clear()
	removeEventHandler( "onClientHUDRender", root, drawContrast)
